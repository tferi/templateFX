...
final case class Reconcilation[Container, FixedItem](container: Container, fixture: Attribute[Container, FixedItem], spec: Option[Template[FixedItem]]) extends Change {

...
final case class MoveNode[Container, Item](collection: JList[Item], currentPosition: Int, targetPosition: Int) extends Change {
  override protected def exec(): Unit = {
    val item = collection.get(currentPosition)
